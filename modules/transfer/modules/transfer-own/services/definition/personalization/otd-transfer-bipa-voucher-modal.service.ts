import { AdfFormatService, IConfirmationModal, IGroupAttributes, IHeadBandAttribute, ConfirmationModalBuilder } from '@adf/components';
import { Injectable } from '@angular/core';
import { TranslateService } from '@ngx-translate/core';
import { IBasicAttributeVC } from 'src/app/models/build.interface';
import { IUserDataModalPdf, IHeadBandLayout } from 'src/app/models/util-work-flow.interface';
...
export class OtdTransferBipaVoucherModalService {
    ...
    builderLayoutVoucherModal(voucherModal: IOTDVoucherModal): IConfirmationModal {
      ...
      const operationDateAttribute: IBasicAttributeVC = {
        ...
        values:[`${dateTime?.standard} ${dateTime?.hour}`],
      ...
      const headBandLayout: IHeadBandLayout = {
        date: dateTime,
        reference: reference,
        numberAccount: accountDebited?.account
      };
      ...
      return new ConfirmationModalBuilder()
        ...
        .subtitle(`${this.translate.instant('No')}. ${reference}`)
